                ...
                items={[
                    {
                        ...
                        icon: step === 1 ? <LoadingOutlined className="!text-[30px]"/> : <Tooltip title="وارد کردن شماره موبایل"><UserOutlined className="!text-[30px]"/></Tooltip>,
                    ...
                    },
                    {
                        ...
                        icon: step === 2 ? <LoadingOutlined className="!text-[30px]"/> : <Tooltip title="تایید کد ارسالی"><SolutionOutlined className="!text-[30px]"/></Tooltip>,
                    ...
                    },
                    {
                        ...
                        icon: step === 3 ? <LoadingOutlined className="text-xl"/> : <Tooltip title="تایید کد سجام"><SafetyOutlined  className="!text-[30px]"/></Tooltip>,
                        description: <div className="text-xs text-gray-900 hidden lg:block mt-2 w-[250px]">در سامانه سجام ثبت نام کنید و با دریافت کد پیگیری ۱۰ رقمی از تکمیل شدن ثبت نام خود مطمئن شوید.</div>
                    },
                    {
                        title: <div className="text-xs font-[700] hidden lg:block mt-2">تایید کد سجام</div>,
